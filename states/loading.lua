...
loading.phases = {
    ...
    function()
       local pl = core.entity.add(game.entity_definitions.player.player(6,1, 20))
          core.entity.add(game.entity_definitions.wall.base_wall(1,1, "wood", "redbrick", nil, nil, "redbrick", nil))
          core.entity.add(game.entity_definitions.wall.base_wall(2,1, "wood", "redbrick", nil, nil, "redbrick", nil))
          core.entity.add(game.entity_definitions.wall.base_wall(4,1, "wood", "redbrick", nil, nil, "redbrick", nil))
          local ent = game.entity_definitions.wall.base_wall(3,1, "wood", "redbrick", nil, nil, "redbrick", nil)
          core.entity.add(ent)
